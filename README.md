# Tomorrow Devs - Coding Bootcamp Slider

![Design preview for the Coding Bootcamp Slider](./design/desktop-preview.jpg)
...
2. Configure your repository to publish your code to a URL. We suggest to use [Netlify](https://netlify.com).
